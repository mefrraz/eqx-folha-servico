...
export default async function UsersPage() {
  ...
  return(<div className="space-y-4"><div><h2 className="text-lg font-bold text-brand-dark">Utilizadores</h2><p className="text-sm text-brand-soft mt-0.5">{workers?.length||0} trabalhadores</p></div>
